...
import backgroundcaramel from "../assets/backgroundcaramel.jpg";
...
export default function HomePage() {
  ...
  return (
    <main className="flex-1 bg-[#ECE6DB] p-8 overflow-auto min-h-screen">
      <div className="mb-4">
        <h1 className="text-5xl flex items-center gap-3 font-bold  text-[#4B1E00]">
      ...
      <section
        ...
        "
        style={{
          backgroundImage: `url(${backgroundcaramel})`,
        }}
      >
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        <div className="bg-white rounded-3xl p-6 shadow-lg">
          ...
          <p className="text-5xl font-bold mt-4 text-[#7A2E00]">
